...
public class Admin implements ActionListener{
	...
	public Admin(Socket socket,String username,String userDir,String userID) {
		try {
			this.socket = socket;
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		String[] Config = manage.getLignes("src/AdminConfig.txt");
		...
		Admin client = new Admin(socket, username , userDir, userID);
...
//						System.out.println(nanoMessage);
	...
	public void sendMessage() {
		try {
			bufferedWriter.write(userDir+ "ß" +userName + "ß" + id);
			bufferedWriter.newLine();
			bufferedWriter.flush();
			String[] data;
